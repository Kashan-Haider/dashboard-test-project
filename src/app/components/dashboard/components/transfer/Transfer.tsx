...
const Transfer = () => {
  ...
  return (
    <div className="" >
      ...
      <div className="flex md:flex-col lg:flex-row gap-1 lg:gap-3 items-center overflow-hidden" >
        <h1 className="text-textColor font-semibold whitespace-nowrap md:text-sm lg:text-base" >Write Amount</h1>
        <div className="relative" >
          <input className="bg-[#EDF1F7] text-textColor focus:text-gray-800 transition-all duration-300 p-2 lg:p-3 rounded-full outline-none w-[190px] lg:w-[230px]" type="text" placeholder="" defaultValue={525.50} />
