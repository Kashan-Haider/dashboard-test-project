    ...
    <div
      className={`${
        props.theme == "light"
          ...
          : "bg-[#4C49ED] text-white"
      } rounded-3xl flex flex-col gap-3 md:gap-1 pt-5 justify-between md:text-xs xl:text-base md:h-[170px] lg:h-[200px] min-w-[280px] md:min-w-[170px]`}
    >
        ...
        <div className="col-span-3">
          <h1
            className={`capitalize ${
              props.theme == "light" ? "text-[#696969b2]" : "text-[#ffffffb2]"
            }`}
          >
            Card Holder
          </h1>
      ...
      <div
        className={`${
          props.theme == "light"
            ? "border-t-[1px] border-t-textColor"
            : "bg-[#ffffff2a] border-t-[1px] border-t-[#4C49ED]"
        } flex items-center justify-between p-3 lg:p-5`}
      >
        <h1 className="">3778 **** **** 1234</h1>
        <Image
          className="w-[20px] lg:w-[30px]"
          src={`/images/card-circles-${
            props.theme == "light" ? "black" : "white"
          }.png`}
          alt="card-circles"
          height={100}
